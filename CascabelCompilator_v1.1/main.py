...
def working_directory(path: Path) -> Iterator[None]:
    """Cambia temporalmente el directorio de trabajo y luego lo restaura."""
...
def generate_code(ast, symbol_table) -> bool:
    ...
    generator = None
    try:
        # CodeGenerator escribe actualmente en 'out.py'. Este cambio temporal
        # garantiza que el archivo se cree junto a main.py sin importar desde
        # qué carpeta se ejecute el compilador.
